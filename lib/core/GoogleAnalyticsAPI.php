...
class GoogleAnalyticsAPI
{
    ...
    const API_URL_REAL_TIME = 'https://www.googleapis.com/analytics/v3/data/realtime';
    ...
    protected function _query($params = array())
    {
        ...
        $data = (startsWith($params['metrics'], 'rt')) ? Http::curl(self::API_URL_REAL_TIME, $queryParams) : Http::curl(self::API_URL, $queryParams); //
        return json_decode($data, $this->assoc);
    }
}
